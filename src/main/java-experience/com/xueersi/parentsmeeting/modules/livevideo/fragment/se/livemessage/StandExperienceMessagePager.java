 ...
 * 修改请注意:直播体验课也走的这里
 */
public class StandExperienceMessagePager extends BaseLiveMessagePager implements LiveAndBackDebug {
...
//        params.topMargin = screenHeight - hradio;
    ...
    private void initOpenBt(boolean open, boolean isVoice) {
        ...
        try {
            ...
            Drawable drawable = DrawableHelper.bitmap2drawable(bitmap);
            if (isVoice) {
                btnVoiceMesOpen.setBackground(drawable);
            } else {
                btMesOpen.setBackground(drawable);
            }
