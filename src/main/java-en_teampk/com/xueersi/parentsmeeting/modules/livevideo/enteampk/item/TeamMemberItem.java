...
public class TeamMemberItem implements AdapterItemInterface<TeamMemberEntity> {
    ...
    public void updateViews(TeamMemberEntity entity, int position, Object objTag) {
        ...
        if (entity.isMy) {
            ...
            iv_livevideo_en_teampk_member.setImageResource(R.drawable.app_livevideo_enteampk_morentouxiang_light_bg_img_nor);
        } else {
            tv_livevideo_en_teampk_name.setBackgroundResource(0);
            iv_livevideo_en_teampk_member.setImageResource(R.drawable.app_livevideo_enteampk_morentouxiang_bg_img_nor);
        }
