...
public class WebRtcAudioRecord {
    ...
    public static OnWebRtcAudioRecordCreate webRtcAudioRecordCreate;
    ...
    WebRtcAudioRecord(Context context, long nativeAudioRecord) {
        ...
        webRtcAudioRecordCreate.onWebRtcAudioRecordCreate(this);
    }

    public interface OnWebRtcAudioRecordCreate{
        void onWebRtcAudioRecordCreate(WebRtcAudioRecord webRtcAudioRecord);
    }
    ...
    private int initRecording(int sampleRate, int channels) {
        Logging.d(TAG, "initRecording(sampleRate=" + sampleRate + ", channels=" + channels + ",hasPermission=" + hasPermission + ")");
        ...
        if (hasPermission==2) {
            reportWebRtcAudioRecordInitError("RECORD_AUDIO permission is missing2");
            return -1;
        }
        if (audioRecord != null) {
