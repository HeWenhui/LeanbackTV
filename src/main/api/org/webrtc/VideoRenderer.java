...
public class VideoRenderer {
    ...
    public static class I420Frame {
        ...
        public I420Frame(int width, int height, int rotationDegree, int[] yuvStrides,
            ...
            if (yuvPlanes == null) {
                yuvPlanes = new ByteBuffer[]{ByteBuffer.allocateDirect(yuvStrides[0] * height), ByteBuffer
                        .allocateDirect(yuvStrides[1] * height),
        ...
        public VideoRenderer.I420Frame copyFrom(VideoRenderer.I420Frame var1) {
            if (Arrays.equals(this.yuvStrides, var1.yuvStrides) && this.width == var1.width && this.height ==
                    var1.height) {
                ...
                throw new RuntimeException("Mismatched dimensions!  Source: " + var1.toString() + ", destination: " +
                        this.toString());
            }
        }
