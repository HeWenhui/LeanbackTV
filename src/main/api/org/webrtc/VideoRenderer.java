...
public class VideoRenderer {
  ...
  public static class I420Frame {
    ...
    public I420Frame(int width, int height, int rotationDegree, int[] yuvStrides,
      ...
      if(yuvPlanes == null) {
        yuvPlanes = new ByteBuffer[]{ByteBuffer.allocateDirect(yuvStrides[0] * height), ByteBuffer.allocateDirect(yuvStrides[1] * height),
                ByteBuffer.allocateDirect(yuvStrides[2] * height)};
      }
    ...
    public VideoRenderer.I420Frame copyFrom(VideoRenderer.I420Frame var1) {
      if(Arrays.equals(this.yuvStrides, var1.yuvStrides) && this.width == var1.width && this.height == var1.height) {
        this.copyPlane(var1.yuvPlanes[0], this.yuvPlanes[0]);
        this.copyPlane(var1.yuvPlanes[1], this.yuvPlanes[1]);
        this.copyPlane(var1.yuvPlanes[2], this.yuvPlanes[2]);
        return this;
      } else {
        throw new RuntimeException("Mismatched dimensions!  Source: " + var1.toString() + ", destination: " + this.toString());
      }
    }
    private void copyPlane(ByteBuffer var1, ByteBuffer var2) {
  ...
  public VideoRenderer(Callbacks callbacks) {
    ...
    Log.i(TAG,"VideoRenderer:nativeVideoRenderer="+nativeVideoRenderer);
