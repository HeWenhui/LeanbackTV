...
public class PeerConnectionFactory {
    ...
    static {
        try {
            ...
            Log.i("PeerConnectionFactory", "loadLibrary");
        } catch (UnsatisfiedLinkError t) {
            nativeLibLoaded = false;
            Log.e("PeerConnectionFactory", "loadLibrary", t);
        }
    }
    ...
    public PeerConnection createPeerConnection(PeerConnection.RTCConfiguration rtcConfig,
        ...
        Log.i(TAG, "createPeerConnection:nativeObserver=" + nativeObserver);
        if (nativeObserver == 0) {
            return null;
        }
    ...
    private static native long nativeCreatePeerConnection(long nativeFactory,
                                                          PeerConnection.RTCConfiguration rtcConfig, MediaConstraints
                                                                  constraints, long nativeObserver);
