        ...
        try {
            ...
            if (isNewArtsH5Courseware(jsonObject) && LiveTopic.MODE_CLASS.equals(mGetInfo.getMode())) {
                ...
                if (ptTypeFilters.contains(videoQuestionLiveEntity.type) && !"1".equals(videoQuestionLiveEntity
                    ...
                    englishH5CoursewareBll.onH5CoursewareMethod(status, "topic1_" + oldstatus, videoQuestionLiveEntity);
                ...
                if ((englishH5CoursewareBll != null && jsonObject.has("H5_Courseware"))
                    ...
                    if ("on".equals(status)) {
                        ...
                        englishH5CoursewareBll.onH5CoursewareMethod(status, "topic2", videoQuestionLiveEntity);
                    } else {
                        // englishH5Entity.setNewEnglishH5(false);
                        if (englishH5CoursewareBll != null) {
...
//                                    LiveVideoConfig.ctId = object.getString("ctId");
                            ...
                            englishH5CoursewareBll.onH5CoursewareMethod(status, "topic3", videoQuestionLiveEntity);
                        }
                    }
                }
            }
        ...
        switch (type) {
            case XESCODE.ENGLISH_H5_COURSEWARE:
                try {
                    if (englishH5CoursewareBll != null) {
                        ...
                        englishH5CoursewareBll.onH5CoursewareMethod(status, "notice1", videoQuestionLiveEntity);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            case XESCODE.QUESTION_TUTOR:
                ...
                if (englishH5CoursewareBll != null) {
                    ...
                    englishH5CoursewareBll.onH5CoursewareMethod(statusTutor, "notice2", turtorEntity);
                }
                break;
            case XESCODE.MULTIPLE_H5_COURSEWARE:
                ...
                if (englishH5CoursewareBll != null) {
                    ...
                    englishH5CoursewareBll.onH5CoursewareMethod(status, "notice3", questionLiveEntity);
                }
                break;
...
//                    String id = object.optString("id", "");
                ...
                englishH5CoursewareBll.onH5CoursewareMethod(artStatus, "notice4", videoQuestionLiveEntity);
                break;
            }
            default:
                break;
...
//                                    }
//                                    animRepo.getResultSuccess(EvenDriveAnimRepository.EvenDriveQuestionType.QUES_TYPE_ENGLISH_NEW_PLATFORM, "");
...
//            }
         ...
         */
        @Override
        public void getStuTestResult(final VideoQuestionLiveEntity detailInfo, final int isPlayBack, AbstractBusinessDataCallBack callBack) {
            EnglishH5Entity englishH5Entity = detailInfo.englishH5Entity;
        ...
        public void submitCourseWareTests(VideoQuestionLiveEntity detailInfo, int isforce, String nonce,
                                          long entranceTime, String testInfos,
                                          AbstractBusinessDataCallBack callBack) {
...
//                }
                if (LiveQueConfig.getSubmitMultiTestTypes().contains(detailInfo.getArtType())) {
                    getCourseWareHttpManager().submitMultiTest("" + testInfos, 1, isforce,
                            new EvenDriveAnimHttpCallBackProxy(callBack, true, QUES_TYPE_ENGLISH_NEW_PLATFORM, detailInfo.id));
                    ...
                    getCourseWareHttpManager().submitH5("" + testInfos,
                            detailInfo.num, detailInfo.id,
                            detailInfo.getArtType(), mGetInfo.getStuId(),
                            1,
                            isforce,
                            new EvenDriveAnimHttpCallBackProxy(callBack, true, QUES_TYPE_ENGLISH_NEW_PLATFORM, detailInfo.id));
                }
...
//                }
        ...
        private class EvenDriveAnimHttpCallBackProxy extends AbstractBusinessDataCallBack {
            ...
            private EvenDriveAnimHttpCallBackProxy(AbstractBusinessDataCallBack httpCallBack, boolean isShowAnim,
                                                   EvenDriveAnimRepository.EvenDriveQuestionType questionType,
                                                   String testId) {
