...
public class StandExperienceFloatWindowManager {
    /**
     * 悬浮窗
     */
    ...
    public static void addView(Context context, View videoView, int type) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            boolean permission = (PackageManager.PERMISSION_GRANTED == pm.checkPermission("android.permission" +
                    ".SYSTEM_ALERT_WINDOW", packname));
            if (permission) {
                wmParams.type = WindowManager.LayoutParams.TYPE_PHONE;
            } else {
