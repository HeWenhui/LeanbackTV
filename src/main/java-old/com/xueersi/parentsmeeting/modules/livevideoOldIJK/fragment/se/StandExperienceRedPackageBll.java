...
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.redpackage.business.RedPackageBll;
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.redpackage.business.RedPackageStandBll;
 ...
 * 全身直播体验课红包Bll，
 */
public class StandExperienceRedPackageBll extends StandExperienceEventBaseBll {
...
//                        EventBus.getDefault().post(new PlaybackVideoEvent.OnGetRedPacket(entity));
                ...
                redPackageBll.setReceiveGold(new RedPackageAction.ReceiveGold() {
                    ...
                    public void sendReceiveGold(int operateId, String liveId, AbstractBusinessDataCallBack callBack) {
                        StandExperienceRedPackageBll.this.sendReceiveGold(questionEntity, operateId, liveId, callBack);
                    }
                });
