...
public class CommonWordChsItem implements AdapterItemInterface<String> {
    ...
    public CommonWordChsItem(Context context, CommonAdapter commonAdapter) {
    ...
    public int getLayoutResId() {
        return R.layout.item_livevideo_message_chs_commonword;
    }
