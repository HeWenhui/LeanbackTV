...
public class PkAnswerResultPager extends SoundEffectPager {
    ...
    public PkAnswerResultPager(Context context, int type, ChinesePkBll teamPKBll) {
        super(context);
        this.awardType = type;
    ...
    public View initView() {
        ...
        final View view = View.inflate(mContext, R.layout.page_livevideo_chpk_answerresult, null);
