...
public class RedPackageStandLog {
    ...
    public static void sno2(LiveAndBackDebug liveAndBackDebug, String operateId) {
    ...
    public static void sno2_2(LiveAndBackDebug liveAndBackDebug, String operateId) {
    ...
    /** 红包第三步，红包榜弹出时间点*/
    public static void sno3(LiveAndBackDebug liveAndBackDebug, String operateId) {
    ...
    /** 红包第四步，幸运儿弹出时间点 */
    public static void sno4(LiveAndBackDebug liveAndBackDebug, String operateId) {
