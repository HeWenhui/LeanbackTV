 ...
 *
 * @author chenkun
 * created 2018/7/27 下午4:23
 * version 1.0
 */
public class FastScrollableRecyclerView extends RecyclerView {


    private RclViewFastScroller fastScroller;

    public FastScrollableRecyclerView(Context context) {
        this(context, null);
    }


    public FastScrollableRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public FastScrollableRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
