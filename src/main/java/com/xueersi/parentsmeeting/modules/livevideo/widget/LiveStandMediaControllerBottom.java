...
public class LiveStandMediaControllerBottom extends MediaControllerBottom {
    public LiveStandMediaControllerBottom(Context context, MediaController controller, MediaPlayerControl player) {
