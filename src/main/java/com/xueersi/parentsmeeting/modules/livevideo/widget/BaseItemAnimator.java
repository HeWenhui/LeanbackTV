...
/**
*recycleView itemView 动画
*@author chekun
*created  at 2018/11/9 14:12
*/
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    void animateMoveImpl(final ViewHolder holder, final int fromX, final int fromY, final int toX, final int toY) {
        ...
        itemMoveAnimationStart(animation,holder,fromX,fromY,toX,toY);
    ...
    /**
     * @param holder   执行动画的item
     * @param startX   移动起始 X
     * @param startY   移动起始 Y
     * @param toX      目标     X
     * @param toY      目标    Y
     */
    public void itemMoveAnimationStart(ViewPropertyAnimatorCompat animator,ViewHolder holder,int startX,int startY,int toX,int toY){
    }

    /**item 布局移动结束*/
    public void itemMoveAnimationEnd(ViewHolder holder){
