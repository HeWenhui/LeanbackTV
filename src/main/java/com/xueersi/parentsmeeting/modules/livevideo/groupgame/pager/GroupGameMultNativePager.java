...
public class GroupGameMultNativePager extends BaseCoursewareNativePager implements BaseEnglishH5CoursewarePager {
    ...
    public GroupGameMultNativePager(Context context, String learningStage, LiveGetInfo liveGetInfo) {
        super(context);
...
//        startSpeechRecognize();
        ...
        workerThread = new WorkerThread(mContext, stuid, false);
        ...
        for (int i = 0; i < entities.size(); i++) {
            ...
            CourseGroupItem courseGroupItem = new CourseGroupItem(workerThread);
