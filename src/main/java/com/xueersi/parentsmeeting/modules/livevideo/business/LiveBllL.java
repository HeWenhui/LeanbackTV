 ...
 * @author linyuqiang
 */
public class LiveBllL extends BaseBll implements LiveAndBackDebug {
    ...
    public LiveBllL(Context context, String vStuCourseID, String courseId, String vSectionID, int form, LiveGetInfo
            liveGetInfo) {
        super(context);
    ...
    public LiveBllL(Context context, String vSectionID, int type, int form) {
        super(context);
        this.mLiveId = vSectionID;
        this.mLiveType = type;
        this.form = form;
    ...
    public LiveBllL(Context context, String vSectionID, String currentDutyId, int type, int form) {
        super(context);
        this.mLiveId = vSectionID;
        this.mLiveType = type;
        ...
        mHttpManager.liveUserOnline(mLiveType, enstuId, mLiveId, teacherId, mCurrentDutyId, mHbTime, new HttpCallBack
            ...
            public void onSuccess(String result) {
                try {
                    ...
                    userOnlineError++;
                    if (mLiveType == LiveBllL.LIVE_TYPE_LIVE) {
                        //liveId
                        //teacherId
                        mLogtf.d("getUserOnline(JSONException):enstuId=" + enstuId + ",mHbCount=" + mHbCount + "," +
                                "teacherId=" + finalTeacherId +
                                ",result=" + result);
                    } else if (mLiveType == LiveBllL.LIVE_TYPE_TUTORIAL) {
                        //classId
                        //dutyId
                        mLogtf.d("getUserOnline(JSONException):enstuId=" + enstuId + ",mHbCount=" + mHbCount + "," +
                                "mCurrentDutyId=" +
                                mCurrentDutyId + ",result=" + result);
                    } else if (mLiveType == LiveBllL.LIVE_TYPE_LECTURE) {
                        //liveId
                        mLogtf.d("getUserOnline(JSONException):enstuId=" + enstuId + ",mHbCount=" + mHbCount + "," +
                                "result=" + result);
                    }
...
//                                    people += 10 * new Random().nextInt(22);
                    ...
                    case XESCODE.TEACHER_PRAISE: {
                        if (mTeacherPraiseBll1 != null) {
                            ...
                            String nonce = object.optString("nonce", "");
                            TeamPkLog.receiveVoicePraise(LiveBllL.this, nonce);
                        }
                        break;
                    }
                    ...
                    case XESCODE.TEAM_PK_TEAM_SELECT: {
                        ...
                        if (mTeamPKBll != null) {
                            ...
                            if (open.equals("1")) {
                                ...
                                TeamPkLog.receiveCreateTeam(LiveBllL.this, nonce, true);
                            } else if (open.equals("0")) {
                                mTeamPKBll.stopTeamSelect();
                                TeamPkLog.receiveCreateTeam(LiveBllL.this, nonce, false);
                            }
                        }
                        break;
                    }
                    case XESCODE.TEAM_PK_SELECT_PKADVERSARY: {
                        ...
                        if (mTeamPKBll != null) {
                            ...
                            if (open.equals("1")) {
                                mTeamPKBll.startSelectAdversary();
                                TeamPkLog.receiveMatchOpponent(LiveBllL.this, nonce, true);
                                Loger.e("LiveBll", "====>onNotice startSelectAdversary:");
                            } else if (open.equals("0")) {
                                mTeamPKBll.stopSelectAdversary();
                                TeamPkLog.receiveMatchOpponent(LiveBllL.this, nonce, false);
                            }
                        }
                        break;
                    }
                    case XESCODE.TEAM_PK_PUBLIC_PK_RESULT:
                        if (mTeamPKBll != null) {
                            String nonce = object.optString("nonce", "");
                            TeamPkLog.receivePkResult(LiveBllL.this, nonce, true);
                            mTeamPKBll.showPkResult();
                        }
                        break;
                    case XESCODE.TEAM_PK_PUBLIC_CONTRIBUTION_STAR: {
                        if (mTeamPKBll != null) {
                            String nonce = object.optString("nonce", "");
                            TeamPkLog.receiveClassBoxInfo(LiveBllL.this, nonce, true);
...
//                    }
        ...
        private boolean isMyTeam(String sender) {
            ...
            if (mLiveType == LiveBllL.LIVE_TYPE_LIVE && !teamStuIds.isEmpty()) {
                isMyTeam = false;
