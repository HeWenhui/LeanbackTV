package com.xueersi.parentsmeeting.modules.livevideo.fragment.se.recommodcourse;
...
public class MarqueeView extends ViewFlipper {
    ...
    @AnimRes
    private int inAnimResId = R.anim.anim_livevideo_bottom_in;
    @AnimRes
    private int outAnimResId = R.anim.anim_livevideo_top_out;

    private int position;
    private List<? extends CharSequence> notices = new ArrayList<>();
    private OnItemClickListener onItemClickListener;
    /**
     * textView上下左右的Drawable
     */
        ...
        if (hasSetDirection) {
            switch (direction) {
                case DIRECTION_BOTTOM_TO_TOP:
                    inAnimResId = R.anim.anim_livevideo_bottom_in;
                    outAnimResId = R.anim.anim_livevideo_top_out;
                    break;
                case DIRECTION_TOP_TO_BOTTOM:
                    inAnimResId = R.anim.anim_livevideo_top_in;
                    outAnimResId = R.anim.anim_livevideo_bottom_out;
                    break;
                case DIRECTION_RIGHT_TO_LEFT:
                    inAnimResId = R.anim.anim_livevideo_right_in;
                    outAnimResId = R.anim.anim_livevideo_left_out;
                    break;
                case DIRECTION_LEFT_TO_RIGHT:
                    inAnimResId = R.anim.anim_livevideo_left_in;
                    outAnimResId = R.anim.anim_livevideo_right_out;
                    break;
            }
        } else {
            inAnimResId = R.anim.anim_livevideo_bottom_in;
     ...
     * @param outAnimResID 离开动画的resID
     */
    public void startWithList(List<? extends CharSequence> notices, @AnimRes int inAnimResId, @AnimRes int
            outAnimResID) {
...
//            if (leftDrawable != null) {
            ...
            textView.setCompoundDrawablePadding(SizeUtils.Dp2Px(getContext(), 3));
//            }
        }
