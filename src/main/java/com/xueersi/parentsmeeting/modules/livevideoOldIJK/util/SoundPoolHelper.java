...
public class SoundPoolHelper {
    ...
    public void playMusic(int resId, float volume, boolean loop) {
        ...
        SoundPlayTask playTask = new SoundPlayTask(SoundPlayTask.RESTYPE_RAW, resId, null, volume, loop);
    ...
    public void playMusic(String path, float volume, boolean loop) {
        ...
        SoundPlayTask playTask = new SoundPlayTask(SoundPlayTask.RESTYPE_RAW, -1, path, volume, loop);
        playTasks.add(playTask);
        if (!isResOnLoading) {
            playMusic(playTasks.remove(0));
        }
