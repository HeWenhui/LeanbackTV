package com.xueersi.parentsmeeting.modules.livevideoOldIJK.chpk.business;
...
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.chpk.page.PkAnswerResultPager;
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.chpk.page.PkDispatchTeamPager;
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.chpk.page.PkOpenAwardPager;
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.chpk.page.PkTeamResultPager;
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.chpk.page.PkTeamSelectPager;
...
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.entity.StudentCoinAndTotalEnergyEntity;
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.entity.StudentPkResultEntity;
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.entity.TeamEnergyAndContributionStarEntity;
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.entity.TeamPkAdversaryEntity;
...
public class ChinesePkBll extends LiveBaseBll implements NoticeAction, TopicAction {
    ...
    public void showPkResult() {
        ...
        mHttpManager.stuCHPKResult(mLiveBll.getLiveId(),
...
//                        TeamPkLog.showClassGoldInfo(mLiveBll, classChestEntity.isMe());
        ...
        mHttpManager.getCHClassChestResult(mLiveBll.getLiveId(),
    ...
    public void startTeamSelect() {
        ...
        mHttpManager.getCHTeamInfo(roomInitInfo.getId(), roomInitInfo.getStudentLiveInfo().getClassId(), roomInitInfo.getStudentLiveInfo().getTeamId(), callBack);
...
//        aqAwardPager.getRootView().setBackgroundColor(Color.BLACK);
    ...
    private void getPkState(final boolean showPopWindow) {
        ...
        mHttpManager.liveCHStuGoldAndTotalEnergy(mLiveBll.getLiveId(),
                roomInitInfo.getStudentLiveInfo().getTeamId(),
                roomInitInfo.getStudentLiveInfo().getClassId(),
                roomInitInfo.getStuId(), callback);
    }
    ...
    public void startSelectAdversary() {
        ...
        mHttpManager.getCHPkAdversary(roomInitInfo.getStudentLiveInfo().getClassId(), roomInitInfo.getStudentLiveInfo
                ().getTeamId(), callback);
...
//        TeamPkLog.showAddPower(mLiveBll, voteId, addEnergy + "");
        ...
        //上报服务器 增加加能量
        mHttpManager.addCHPersonAndTeamEnergy(mLiveBll.getLiveId(), addEnergy,
                roomInitInfo.getStudentLiveInfo().getTeamId(),
...
//        TeamPkLog.clickFastEnter(mLiveBll);
        mHttpManager.getCHTeamInfo(roomInitInfo.getId(), roomInitInfo.getStudentLiveInfo().getClassId(),
    ...
    private void getEnergyNumAndContributionStar() {
        ...
        if (LiveVideoConfig.isNewEnglishH5) {
            ...
            mHttpManager.teamCHEnergyNumAndContributionmulStar(mLiveBll.getLiveId(),
                    roomInitInfo.getStudentLiveInfo().getTeamId(),
                    roomInitInfo.getStudentLiveInfo().getClassId(),
                    roomInitInfo.getStuId(),
            ...
            mHttpManager.teamCHEnergyNumAndContributionStar(mLiveBll.getLiveId(),
                    roomInitInfo.getStudentLiveInfo().getTeamId(),
                    roomInitInfo.getStudentLiveInfo().getClassId(),
                    roomInitInfo.getStuId(),
                    savedTestId,
