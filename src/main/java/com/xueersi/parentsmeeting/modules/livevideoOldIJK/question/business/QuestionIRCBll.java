...
import com.xueersi.parentsmeeting.modules.livevideoOldIJK.business.RolePlayMachineAction;
...
//                FeedBackEntity entity = getIntelligentRecognitionHttpResponseParser().parseFeedBackContent(responseEntity);
