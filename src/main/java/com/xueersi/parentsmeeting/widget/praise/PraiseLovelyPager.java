 ...
 * @param hua
 */
public class PraiseLovelyPager extends PraisePager {


    public PraiseLovelyPager(Context context, PraiseEntity praiseEntity) {
    ...
    protected void setPriseType() {
        ...
        if (mPraiseEntity.getPraiseType() == PraiseConfig.PRAISE_TYPE_PRACTICE) {
            ...
            ivTitle.setBackgroundResource(R.drawable.bg_page_livevideo_praise_list_lovely_title_1);
            // 口述题表扬榜
        } else if (mPraiseEntity.getPraiseType() == PraiseConfig.PRAISE_TYPE_TALK) {
            tvTitle.setVisibility(View.GONE);
            ivTitle.setVisibility(View.VISIBLE);
            ivTitle.setBackgroundResource(R.drawable.bg_page_livevideo_praise_list_lovely_title_2);
            // 互动题表扬榜
        } else if (mPraiseEntity.getPraiseType() == PraiseConfig.PRAISE_TYPE_QUESITON) {
            tvTitle.setVisibility(View.GONE);
            ivTitle.setVisibility(View.VISIBLE);
            ivTitle.setBackgroundResource(R.drawable.bg_page_livevideo_praise_list_lovely_title_3);
            // 其他表扬榜
        } else {
    ...
    protected void setReslutType() {
        ...
        if(mPraiseEntity.getResultType() == PraiseConfig.RESULT_PRAISE){
            tvSubTitle.setTextColor(getColor(R.color.COLOR_FFBC2D));
