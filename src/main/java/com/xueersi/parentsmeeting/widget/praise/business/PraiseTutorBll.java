...
public class PraiseTutorBll extends LiveBaseBll implements NoticeAction, TopicAction, PraiseListPresenter {
    /**
     * 表扬榜View层接口
     */
    ...
    public PraiseTutorBll(Activity context, LiveBll2 liveBll) {
        ...
        mPraiseListView.setPresenter(PraiseTutorBll.this);
    }
