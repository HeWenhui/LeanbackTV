...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_5_0_node_modules_css_loader_dist_cjs_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_animation_vue_vue_type_style_index_0_id_4156337a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_5_0_node_modules_css_loader_dist_cjs_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_animation_vue_vue_type_style_index_0_id_4156337a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_5_0_node_modules_css_loader_dist_cjs_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_animation_vue_vue_type_style_index_0_id_4156337a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_5_0_node_modules_css_loader_dist_cjs_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_animation_vue_vue_type_style_index_0_id_4156337a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=8715f7c6&
...
var set_timeout = __webpack_require__(19);
...
var querystringify = __webpack_require__(26);
...
var createApi_chs = !!formatParams.chs;
console.log(createApi_chs);
var createRequest = axios_default.a.create({
  baseURL: createApi_chs ? 'https://live.chs.xueersi.com' : 'https://live.xueersi.com/science',
  // baseURL: chs ? '/' : '/science',
...
var API_getStudentAnsweredResultData = function API_getStudentAnsweredResultData(params) {
  return createApi_request(createRequest.get('/LiveExam/getStuTestResult', {
    params: params
  }));
}; // 组内答题情况饼状图统计接口
...
var API_getTeamAnwseredResultPieData = function API_getTeamAnwseredResultPieData(params) {
  return createApi_request(createRequest.get('/LiveExam/teamTestStatistics', {
    params: params
  }));
...
var API_getTeamTop15ListData = function API_getTeamTop15ListData(params) {
  return createApi_request(createRequest.get('/LiveExam/testStatisticsList', {
    params: params
  }));
}; // 是否有连对


var API_ifNeedShowRightAnimation = function API_ifNeedShowRightAnimation(_ref) {
  var liveId = _ref.liveId;
  return createApi_request(createRequest.get('/Stimulation/isOpenCouseWare', {
    params: {
      liveId: liveId
    }
  }));
...
var API_getStudentRightManyTimeData = function API_getStudentRightManyTimeData(params) {
  return createApi_request(createRequest.get('/Stimulation/getRightNums', {
    params: params
  }));
};
...
/* harmony default export */ var createApi = ({
  ...
  API_ifNeedShowRightAnimation: API_ifNeedShowRightAnimation,
  API_getStudentRightManyTimeData: API_getStudentRightManyTimeData
});
...
var fill = __webpack_require__(51);
...
var mainvue_type_style_index_0_id_4d935864_lang_scss_scoped_true_ = __webpack_require__(171);
...
// CONCATENATED MODULE: /Users/zhangting/Downloads/git/GitLab/fe-hybride-stage/node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!/Users/zhangting/Downloads/git/GitLab/fe-hybride-stage/node_modules/vue-loader/lib??vue-loader-options!./src/components/rightAnimation/animation.vue?vue&type=template&id=4156337a&scoped=true&
var animationvue_type_template_id_4156337a_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"fade"},on:{"after-leave":_vm.destroyElement}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],ref:"aniRef",staticClass:"animation"})])}
var animationvue_type_template_id_4156337a_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/rightAnimation/animation.vue?vue&type=template&id=4156337a&scoped=true&

// EXTERNAL MODULE: ./node_modules/lottie-web/build/player/lottie.js
var lottie = __webpack_require__(87);
var lottie_default = /*#__PURE__*/__webpack_require__.n(lottie);

// CONCATENATED MODULE: /Users/zhangting/Downloads/git/GitLab/fe-hybride-stage/node_modules/babel-loader/lib??ref--0!/Users/zhangting/Downloads/git/GitLab/fe-hybride-stage/node_modules/vue-loader/lib??vue-loader-options!./src/components/rightAnimation/animation.vue?vue&type=script&lang=js&
...
var animationvue_type_script_lang_js_sleep = function sleep(d) {
...
/* harmony default export */ var animationvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    createAnimation: function createAnimation() {
      var ani = lottie_default.a.loadAnimation({
        container: this.$refs.aniRef,
    ...
    playOnce: function playOnce() {
      ...
      var playAnimationPromise = new promise_default.a(
      /*#__PURE__*/
      function () {
        var _ref = asyncToGenerator_default()(
        /*#__PURE__*/
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _this.visible = true;
                  _context.next = 3;
                  return animationvue_type_script_lang_js_sleep(20);

                case 3:
                  _this.ani = _this.createAnimation();

                  _this.ani.onComplete = function () {
      ...
      return playAnimationPromise;
    }
  }
});
// CONCATENATED MODULE: ./src/components/rightAnimation/animation.vue?vue&type=script&lang=js&
 /* harmony default export */ var rightAnimation_animationvue_type_script_lang_js_ = (animationvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/components/rightAnimation/animation.vue?vue&type=style&index=0&id=4156337a&scoped=true&lang=css&
var animationvue_type_style_index_0_id_4156337a_scoped_true_lang_css_ = __webpack_require__(174);

// CONCATENATED MODULE: ./src/components/rightAnimation/animation.vue
...
var animation_component = Object(componentNormalizer["a" /* default */])(
  rightAnimation_animationvue_type_script_lang_js_,
  animationvue_type_template_id_4156337a_scoped_true_render,
  animationvue_type_template_id_4156337a_scoped_true_staticRenderFns,
  false,
  null,
  "4156337a",
  null
...
// CONCATENATED MODULE: ./src/components/rightAnimation/index.js




var AnimationConstructor = vue_runtime_default.a.extend(animation);

var $createRightAnimation =
/*#__PURE__*/
function () {
  var _ref = asyncToGenerator_default()(
  /*#__PURE__*/
  ...
  return function $createRightAnimation(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    getter_teamGroupTop15Data: function getter_teamGroupTop15Data() {
      return this.var_teamTop15ListData ? this.var_teamTop15ListData.groupRank : [];
    },
  ...
  methods: {
        ...
        return regenerator_default.a.wrap(function _callee2$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                _context3.next = 6;
                return this.requestStudentRightManyTimeData();
    ...
    // 获取激励连对数量接口
    requestStudentRightManyTimeData: function () {
      var _requestStudentRightManyTimeData = asyncToGenerator_default()(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee3() {
        var ifshow, isOpen, res, _context4, num, jsonIndex, animationPath;
        ...
        return regenerator_default.a.wrap(function _callee3$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return createApi.API_ifNeedShowRightAnimation(formatParams);

              case 2:
                ifshow = _context5.sent;
                isOpen = ifshow.data.isOpen;
                ...
                return _context5.abrupt("return", console.log('未开启连对'));

              case 6:
                _context5.next = 8;
                return createApi.API_getStudentRightManyTimeData(formatParams);

              case 8:
                res = _context5.sent;
                // const res = { data: {num: 29} }
                console.log('学生作答连对数量 ===>', res.data);
                ...
                num = res.data.num;
                jsonIndex = Math.min(8, num % 2 ? num - 1 : num);
                num = Math.min(25, num);
                animationPath = concat_default()(_context4 = "animations/".concat(jsonIndex, "/data-")).call(_context4, num, ".json");
                _context5.next = 17;
                return $createRightAnimation({
      ...
      function requestStudentRightManyTimeData() {
        return _requestStudentRightManyTimeData.apply(this, arguments);
      }

      return requestStudentRightManyTimeData;
    }(),
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                return _context9.abrupt("return", this.requestAllResultPageData());
...
var App_component = Object(componentNormalizer["a" /* default */])(
  ...
  Appvue_type_template_id_8715f7c6_render,
  staticRenderFns,
  false,
  null,
  null,
...
},[[176,"manifest","vendors~main"]]]);
//# sourceMappingURL=main.8c316c90f02de474eb60.js.map